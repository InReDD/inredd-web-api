...
-- set data directory
SELECT set_config('data_directory', CONCAT(current_setting('data_directory'), '/', true); 
...
SELECT 1, '0000', NULL, 'Profa.', 'Institution Example', '5404143204431052',
     pg_read_binary_file(CONCAT(current_setting('data_directory'), '/firebase/memberImages/MirelaCazzolato.jpg'),
...
SELECT 2, '0000', NULL, 'Profa. Dra.', '0', '2407277993285186',
     pg_read_binary_file(CONCAT(current_setting('data_directory'), '/firebase/memberImages/AlessandraAlaniz.jpeg'),
...
SELECT 3, '0000', NULL, 'Profa. Dra.', '0', '8527991428093010',
     pg_read_binary_file(CONCAT(current_setting('data_directory'), '/firebase/memberImages/camilaTirapelli.png')),
...
SELECT 4, '0000', NULL, 'Prof. Dr.', '0', '1652639775122637',
     pg_read_binary_file(CONCAT(current_setting('data_directory'), '/firebase/memberImages/hugoGaeta.png')),
...
SELECT 5, '0000', NULL, '', '0', '1373401174969764',
     pg_read_binary_file(CONCAT(current_setting('data_directory'), '/firebase/memberImages/pedroBastos.png')),
...
SELECT 6, '0000', NULL, '', '0', '2407277993285186',
     pg_read_binary_file(CONCAT(current_setting('data_directory'), '/firebase/memberImages/julioRuiz.png')),
...
SELECT 7, '0000', NULL, '', '0', '9528069961011665',
     pg_read_binary_file(CONCAT(current_setting('data_directory'), '/firebase/memberImages/camilaPortoCapel.png')),
...
SELECT 8, '0000', NULL, '', '0', '6859938738453631',
     pg_read_binary_file(CONCAT(current_setting('data_directory'), '/firebase/memberImages/gabrielaAyres.png')),
...
SELECT 9, '0000', NULL, '', '0', '5790574018465089',
     pg_read_binary_file(CONCAT(current_setting('data_directory'), '/firebase/memberImages/leandroCardoso.png')),
...
SELECT 10, '0000', NULL, '', '0', '3051734743750193',
     pg_read_binary_file(CONCAT(current_setting('data_directory'), '/firebase/memberImages/muriloMontari.png')),
...
SELECT 12, '0000', NULL, '', '0', '9682458931179370',
     pg_read_binary_file(CONCAT(current_setting('data_directory'), '/firebase/memberImages/ericArnold.png')),
...
SELECT 13, '0000', NULL, '', '0', '1576892464551687',
     pg_read_binary_file(CONCAT(current_setting('data_directory'), '/firebase/memberImages/thiagoAlves.png')),
...
SELECT 14, '0000', NULL, '', '0', '2131728266711395',
     pg_read_binary_file(CONCAT(current_setting('data_directory'), '/firebase/memberImages/ViniciusMelo.jpg'),
...
SELECT 15, '0000', NULL, '', '0', '6014220679248199',
     pg_read_binary_file(CONCAT(current_setting('data_directory'), '/firebase/memberImages/michelleChang.png')),
...
SELECT 16, '0000', NULL, '', '0', '2820894116965168',
     pg_read_binary_file(CONCAT(current_setting('data_directory'), '/firebase/memberImages/brenoZancan.png')),
...
SELECT 17, '0000', NULL, '', '0', '2157452587942180',
     pg_read_binary_file(CONCAT(current_setting('data_directory'), '/firebase/memberImages/iagoFonseca.png')),
...
SELECT 18, '0000', NULL, '', '0', '5334650938944366',
     pg_read_binary_file(CONCAT(current_setting('data_directory'), '/firebase/memberImages/marianaSoares.png')),
...
SELECT 19, '0000', NULL, '', '0', '4643111511552418',
     pg_read_binary_file(CONCAT(current_setting('data_directory'), '/firebase/memberImages/gabrielaGreghi.png')),
...
SELECT 20, '0000', NULL, '', '0', '4347068369827764',
     pg_read_binary_file(CONCAT(current_setting('data_directory'), '/firebase/memberImages/caioUehara.png')),
...
SELECT 21, '0000', NULL, '', '0', '3790288170098950',
     pg_read_binary_file(CONCAT(current_setting('data_directory'), '/firebase/memberImages/marcelaAmanda.png')),
...
SELECT 22, '0000', NULL, '', '0', '5884239564831518',
     pg_read_binary_file(CONCAT(current_setting('data_directory'), '/firebase/memberImages/gabrielFugita.png')),
     'Graduando em Odontologia pela Faculdade de Odontologia de Ribeirão Preto da Universidade de São Paulo – FORP/USP; Aluno de Iniciação Científica do grupo InReDD.'
WHERE NOT EXISTS (SELECT 1 FROM academic WHERE id_user = 22);

INSERT INTO academic (id_user, contact, id_address, title, institution, lattes_id, profile_picture, biography)
SELECT 23, '0000', NULL, '', '0', '0684260742261428',
     pg_read_binary_file(CONCAT(current_setting('data_directory'), '/firebase/memberImages/brunaNeves.png')),
     'Graduada em Odontologia pelo Centro Universitário Fluminense de Campos-UNIFLU; Mestre em Odontologia com área de concentração em Reabilitação Oral pela Faculdade de Odontologia de Ribeirão Preto da Universidade de São Paulo – FORP/USP; Doutora em Odontologia com área de concentração em Reabilitação Oral pela Faculdade de Odontologia de Ribeirão Preto da Universidade de São Paulo – FORP/USP; Pós-Doutoranda em Odontologia com área de concentração em Reabilitação Oral pela Faculdade de Odontologia de Ribeirão Preto da Universidade de São Paulo – FORP/USP; Professora Contratada III na Disciplina de Prótese Parcial Fixa I pela Faculdade de Odontologia de Ribeirão Preto da Universidade de São Paulo – FORP/USP (2023); Pesquisadora visitante no Departamento de Odontologia e Saúde Bucal da Universidade de Aarhus (2024-atual).'
WHERE NOT EXISTS (SELECT 1 FROM academic WHERE id_user = 23);

INSERT INTO academic (id_user, contact, id_address, title, institution, lattes_id, profile_picture, biography)
SELECT 24, '0000', NULL, '', '0', '2430315747607049',
     pg_read_binary_file(CONCAT(current_setting('data_directory'), '/firebase/memberImages/karenPintado.png')),
