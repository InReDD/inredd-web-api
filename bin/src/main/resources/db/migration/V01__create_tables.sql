-- Drop the schema if it exists (CASCADE removes all dependent objects)
DROP SCHEMA IF EXISTS inredd_schema CASCADE;

-- Create the schema (PostgreSQL databases have an encoding set at creation time)
CREATE SCHEMA IF NOT EXISTS inredd_schema;
